...
namespace AoC2020.Day21
{
    public static class PartOne
    {
        ...
        public static int Solve()
        {
            ...
            var allergens = foodList.SelectMany(x => x.Allergens)
                                    .ToHashSet()
                                    .ToArray();
            ...
            var aa = bar.Select(x => x.Value[0]);
            var bb = foodList.SelectMany(x => x.Ingredients).ToList();

            bb.RemoveAll(x => aa.Contains(x));
